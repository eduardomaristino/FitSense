...
void mostrarFrequencia() {
    ...
    // Verifica se há registro de frequência para o aluno ATENÇÃO AQUI - ATENÇÃO AQUI - ATENÇÃO AQUI - ATENÇÃO AQUI ------
	...
	if (frequencia[i].id_aluno == id_aluno && strcmp(frequencia[i].data, data) == ) {
        printf("ATENÇÃO: O ALUNO INFORMADO AINDA NÃO POSSUI FREQUÊNCIA CADASTRADA NO SISTEMA.\n");
    }    
    */

    
    printf("\nFrequência do aluno no dia %s:\n", data);
